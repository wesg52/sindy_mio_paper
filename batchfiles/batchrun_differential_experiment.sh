...
python ../differential_experiment.py -s hopf -t $SLURM_ARRAY_TASK_ID -o 5 -n final_draft_dif
python ../differential_experiment.py -s mhd -t $SLURM_ARRAY_TASK_ID -o 3 -n final_draft_dif
